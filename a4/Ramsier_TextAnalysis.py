...
def create_stopwords_list():
    ...
    # Creates stopword list from stopwords.txt
    try:
        stopwords = []
...
def calculate_word_frequencies(stopwords):
    ...
    try:
        # creates dictionary and counter variables
        word_dict = {}
        stopword_counter = 0
        word_counter = 0
        ...
        # goes through each line of text
        for line in input_file:
            # normalizes words
            word_list = remove_punctuation(line)
            # increments through each word in each line
        ...
        # prints total word count and total stopword count
        print("Total word count:", total_word_count)
        print("Total stopword count:", stopword_counter)
        # closes file
        input_file.close()
        # returns dictionary with all non-stopwords and their frequencies
        return word_dict
    # exception handling
    except FileNotFoundError as err:
        print("File could not be found.")
